...
parser.add_argument("--data_dir", type=str, default='./patchingforgan')
...
# writer = SummaryWriter('logs/WGAN1')
lossg2 = []
lossd2 = []
...
for epoch in range(opt.n_epochs):
    ...
    for i, imgs in enumerate(dataloader):
        ...
        if i % opt.n_critic == 0:
            ...
            if batches_done % opt.sample_interval == 0:
                ...
                for i in range(25):
                    save_image(gen_imgs.data[i],'images/%d-%d.png' % (batches_done,i))
            batches_done += 1
    ...
    if epoch % 5000 == 0:
        torch.save(generator, './GAN/WGAN_G_{}.pth'.format(epoch))
...
dict.to_csv('./GAN/transverse.csv')
